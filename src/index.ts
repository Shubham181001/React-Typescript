...
const enum Values {
    a = 10,
    b = 20,
    c = a + b // enums are already constant collection but if it has expression then it is not necessary to put enum as constant but it is recommended to use it as constant because the expression is dynamic and it can change and we don't want that to happen.
}
